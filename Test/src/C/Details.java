...
public class Details implements Comparable<Details>{
	...
	public String toString() {
		return "Details [houseNumber=" + houseNumber + ", StreetNumber=" + StreetNumber + ", Locality=" + Locality
				+ ", city=" + city + ", state=" + state + ", pincode=" + pincode + ", getHouseNumber()="
				+ getHouseNumber() + ", getStreetNumber()=" + getStreetNumber() + ", getLocality()=" + getLocality()
